...
//	EQUIPMENT TRADER
	...
	class U_Competitor 								{ quality = 2; price = 200; };
	class U_C_Poor_1 								{ quality = 2; price = 200; };
	class U_C_Poor_2 								{ quality = 2; price = 200; };
	class U_C_Poor_shorts_1 						{ quality = 2; price = 200; };
	...
	class U_C_Man_casual_1_F          				{ quality = 2; price = 200; };
	class U_C_Man_casual_2_F          				{ quality = 2; price = 200; };
	class U_C_Man_casual_3_F          				{ quality = 2; price = 200; };
	class U_C_Man_casual_4_F          				{ quality = 2; price = 200; };
	class U_C_Man_casual_5_F          				{ quality = 2; price = 200; };
	class U_C_Man_casual_6_F          				{ quality = 2; price = 200; };
	...
	class U_IG_Guerilla1_1							{ quality = 3; price = 300; };
	class U_IG_Guerilla2_1							{ quality = 3; price = 300; };
	class U_IG_Guerilla2_2							{ quality = 3; price = 300; };
	class U_BG_Guerilla2_1							{ quality = 3; price = 300; };
	class U_BG_Guerrilla_6_1						{ quality = 3; price = 300; };
	class U_BG_Guerilla1_1							{ quality = 3; price = 300; };
	class U_BG_Guerilla2_2							{ quality = 3; price = 300; };
	class U_BG_Guerilla2_3							{ quality = 3; price = 300; };
	class U_IG_Guerilla2_3							{ quality = 3; price = 300; };		//	Guerilla Outfit (Plain, Light)
	
	class U_IG_leader								{ quality = 3; price = 400; };		// 	Guerilla Uniform
	
	class U_IG_Guerilla3_1							{ quality = 3; price = 500; };		//	Guerilla Smocks
	class U_IG_Guerilla3_2							{ quality = 3; price = 500; };		//	Guerilla Smocks 1
	...
	class U_I_C_Soldier_Bandit_1_F    				{ quality = 3; price = 300; };
	class U_I_C_Soldier_Bandit_2_F    				{ quality = 3; price = 300; };
	class U_I_C_Soldier_Bandit_3_F    				{ quality = 3; price = 300; };
	class U_I_C_Soldier_Bandit_4_F    				{ quality = 3; price = 300; };
	class U_I_C_Soldier_Bandit_5_F   				{ quality = 3; price = 300; };
	...
	class U_B_CombatUniform_mcam 					{ quality = 4; price = 800; };
	class U_B_CombatUniform_mcam_tshirt 			{ quality = 4; price = 800; };
	class U_B_CombatUniform_mcam_vest 				{ quality = 4; price = 800; };
	class U_B_CombatUniform_mcam_worn 				{ quality = 4; price = 800; };
	
	class U_B_CTRG_1 								{ quality = 4; price = 800; };
	class U_B_CTRG_2 								{ quality = 4; price = 800; };
	class U_B_CTRG_3								{ quality = 4; price = 800; };
	
	class U_I_CombatUniform 						{ quality = 4; price = 800; };
	class U_I_CombatUniform_shortsleeve				{ quality = 4; price = 800; };
	class U_I_CombatUniform_tshirt					{ quality = 4; price = 800; };
	
	class U_I_OfficerUniform						{ quality = 4; price = 800; };
	
	class U_O_CombatUniform_ocamo 					{ quality = 4; price = 800; };
	class U_O_CombatUniform_oucamo 					{ quality = 4; price = 800; };
	
	class U_O_OfficerUniform_ocamo 					{ quality = 4; price = 800; };
	
	class U_B_SpecopsUniform_sgg 					{ quality = 4; price = 800; };
	class U_O_SpecopsUniform_blk 					{ quality = 4; price = 800; };
	class U_O_SpecopsUniform_ocamo 					{ quality = 4; price = 800; };
	
	class U_I_G_Story_Protagonist_F 				{ quality = 4; price = 800; };
	
	class Exile_Uniform_Woodland 					{ quality = 6; price = 4000; };
	
	//	APEX DLC
	class U_B_T_Soldier_F             				{ quality = 4; price = 800; };
	class U_B_T_Soldier_AR_F          				{ quality = 4; price = 800; };	
	class U_B_T_Soldier_SL_F          				{ quality = 4; price = 800; };
	
	class U_B_GEN_Soldier_F           				{ quality = 3; price = 400; };
	class U_B_GEN_Commander_F         				{ quality = 3; price = 300; };
	
	class U_O_T_Soldier_F             				{ quality = 4; price = 800; };
	class U_O_T_Officer_F             				{ quality = 4; price = 800; };
	
	class U_I_C_Soldier_Para_1_F      				{ quality = 4; price = 800; };
	class U_I_C_Soldier_Para_2_F      				{ quality = 4; price = 800; };
	class U_I_C_Soldier_Para_3_F      				{ quality = 4; price = 800; };
	class U_I_C_Soldier_Para_4_F      				{ quality = 4; price = 800; };
	class U_I_C_Soldier_Para_5_F      				{ quality = 4; price = 800; };
	
	class U_I_C_Soldier_Camo_F        				{ quality = 4; price = 800; };		//	Syndikat Uniform
	
	class U_B_CTRG_Soldier_F          				{ quality = 4; price = 800; };
	class U_B_CTRG_Soldier_2_F        				{ quality = 4; price = 800; };
	class U_B_CTRG_Soldier_3_F        				{ quality = 4; price = 800; };	
	class U_B_CTRG_Soldier_urb_1_F    				{ quality = 4; price = 800; };
	class U_B_CTRG_Soldier_urb_2_F    				{ quality = 4; price = 800; };
	class U_B_CTRG_Soldier_urb_3_F    				{ quality = 4; price = 800; };
	
	class U_O_V_Soldier_Viper_F       				{ quality = 6; price = 25000; };
	class U_O_V_Soldier_Viper_hex_F   				{ quality = 6; price = 25000; };
	...
	class U_B_HeliPilotCoveralls					{ quality = 5; price = 2000; };		//	Heli Pilot Coveralls		Capacity: 40
	class U_I_HeliPilotCoveralls					{ quality = 5; price = 3000; };		//	Heli Pilot Coveralls [AAF]	Capacity: 60
	
	class U_B_PilotCoveralls						{ quality = 5; price = 3000; };		//	Pilot Coveralls [NATO]		Capacity: 60
	class U_I_pilotCoveralls						{ quality = 5; price = 3000; };		//	Pilot Coveralls [AAF]		Capacity: 60
	class U_O_PilotCoveralls						{ quality = 5; price = 3000; };		//	Pilot Coveralls [CSAT]		Capacity: 60
	...
	class U_B_T_Sniper_F              				{ quality = 6; price = 6000; };		//	Capacity: 60
	class U_I_GhillieSuit							{ quality = 6; price = 6000; };
	class U_B_GhillieSuit							{ quality = 6; price = 6000; };
	class U_O_GhillieSuit							{ quality = 6; price = 6000; };
	
	class U_B_T_FullGhillie_tna_F     				{ quality = 6; price = 7000; };
	class U_B_FullGhillie_ard						{ quality = 6; price = 7000; };
	class U_B_FullGhillie_lsh						{ quality = 6; price = 7000; };
	class U_B_FullGhillie_sard						{ quality = 6; price = 7000; };
	class U_I_FullGhillie_ard						{ quality = 6; price = 7000; };
	class U_I_FullGhillie_lsh						{ quality = 6; price = 7000; };
	class U_I_FullGhillie_sard						{ quality = 6; price = 7000; };
	class U_O_FullGhillie_ard						{ quality = 6; price = 7000; };
	class U_O_FullGhillie_lsh						{ quality = 6; price = 7000; };
	class U_O_FullGhillie_sard						{ quality = 6; price = 7000; };

	//	APEX DLC
	class U_O_T_Sniper_F              				{ quality = 5; price = 4000; };		// Capacity: 40
	class U_O_T_FullGhillie_tna_F     				{ quality = 6; price = 7000; };
...
//	VESTS
	...
	class V_Rangemaster_belt						{ quality = 1; price = 500; };
	...
	class V_BandollierB_blk							{ quality = 1; price = 2000; };
	class V_BandollierB_cbr							{ quality = 1; price = 2000; };
	class V_BandollierB_khk							{ quality = 1; price = 2000; };
	class V_BandollierB_oli							{ quality = 1; price = 2000; };
	class V_BandollierB_rgr							{ quality = 1; price = 2000; };
	...
	//class V_HarnessO_brn							{ quality = 3; price = 750; };
	//class V_HarnessO_gry							{ quality = 3; price = 750; };
	//class V_HarnessO_ghex_F           			{ quality = 3; price = 750; };
	class V_HarnessOGL_brn							{ quality = 2; price = 3000; };
	class V_HarnessOGL_gry							{ quality = 2; price = 3000; };
	class V_HarnessOGL_ghex_F         				{ quality = 2; price = 3000; };
	...
	class V_Chestrig_blk 							{ quality = 2; price = 4000; };
	class V_Chestrig_khk 							{ quality = 2; price = 4000; };
	class V_Chestrig_oli 							{ quality = 2; price = 4000; };
	class V_Chestrig_rgr 							{ quality = 2; price = 4000; };
	...
	class V_TacVest_blk								{ quality = 2; price = 5000; };
	class V_TacVest_brn								{ quality = 2; price = 5000; };
	class V_TacVest_camo							{ quality = 2; price = 5000; };
	class V_TacVest_khk								{ quality = 2; price = 5000; };
	class V_TacVest_oli								{ quality = 2; price = 5000; };
	...
	class V_PlateCarrier1_blk 						{ quality = 3; price = 6000; };	// Carrier Lite Black
	class V_PlateCarrier1_rgr 						{ quality = 3; price = 6000; }; // Carrier Lite Green
	class V_PlateCarrier1_tna_F       				{ quality = 3; price = 6000; }; // Carrier Lite Tropic
	...
	class V_PlateCarrierL_CTRG 						{ quality = 3; price = 6000; };		// Carrier Lite CTRG
	class V_PlateCarrierH_CTRG 						{ quality = 4; price = 7000; };		// Carrier Rig CTRG
	...
	class V_PlateCarrier3_rgr 						{ quality = 4; price = 7000; }; // Carrier Rig Green
	class V_PlateCarrier2_tna_F       				{ quality = 4; price = 7000; }; // Carrier Rig Tropic
	...
	class V_PlateCarrierSpec_blk 					{ quality = 5; price = 8000; };
	class V_PlateCarrierSpec_mtp 					{ quality = 5; price = 8000; };
	class V_PlateCarrierSpec_rgr 					{ quality = 5; price = 8000; };
	class V_PlateCarrierSpec_tna_F    				{ quality = 5; price = 8000; };
	...
	class V_PlateCarrierIAGL_dgtl 					{ quality = 6; price = 9000; };		// GA Carrier GL Rig Digi
	class V_PlateCarrierIAGL_oli 					{ quality = 6; price = 9000; };		// GA Carrier GL Rig Olive	
	...
	class V_PlateCarrierGL_blk 						{ quality = 6; price = 10000; };
	class V_PlateCarrierGL_mtp 						{ quality = 6; price = 10000; };
	class V_PlateCarrierGL_rgr 						{ quality = 6; price = 10000; };
	class V_PlateCarrierGL_tna_F      				{ quality = 6; price = 10000; };
...
//	FACEWEAR
	...
	class G_Combat			 						{ quality = 2; price = 250; };
	class G_Lowprofile			 					{ quality = 2; price = 250; };
	class G_Combat_Goggles_tna_F					{ quality = 2; price = 250; };
	class G_Goggles_VR			 					{ quality = 2; price = 250; };
	class G_Bandanna_blk			 				{ quality = 3; price = 500; };
	class G_Bandanna_oli			 				{ quality = 3; price = 500; };
	class G_Bandanna_khk			 				{ quality = 3; price = 500; };
	class G_Bandanna_tan			 				{ quality = 3; price = 500; };
	class G_Bandanna_beast			 				{ quality = 4; price = 600; };
	class G_Bandanna_shades			 				{ quality = 4; price = 600; };
	class G_Bandanna_sport			 				{ quality = 4; price = 600; };
	class G_Bandanna_aviator						{ quality = 4; price = 600; };
	class G_Balaclava_blk			 				{ quality = 5; price = 1000; };
	class G_Balaclava_oli			 				{ quality = 5; price = 1000; };
	class G_Balaclava_combat						{ quality = 5; price = 1500; };
	class G_Balaclava_lowprofile					{ quality = 5; price = 1500; };
	class G_Balaclava_TI_blk_F						{ quality = 6; price = 2000; };
	class G_Balaclava_TI_tna_F						{ quality = 6; price = 2000; };
	class G_Balaclava_TI_G_blk_F					{ quality = 6; price = 2500; };
	class G_Balaclava_TI_G_tna_F					{ quality = 6; price = 2500; };
...
//	HEADGEAR
	...
	class Exile_Headgear_SantaHat					{ quality = 6; price = 30000; };
	class Exile_Headgear_SafetyHelmet				{ quality = 6; price = 10000; };
	class H_Helmet_Skate              				{ quality = 6; price = 5000; };
	...
	class H_Beret_02								{ quality = 1; price = 500; };
	class H_Beret_blk								{ quality = 1; price = 500; };
	class H_Beret_blk_POLICE						{ quality = 1; price = 500; };
	class H_Beret_brn_SF							{ quality = 1; price = 500; };
	class H_Beret_Colonel							{ quality = 1; price = 500; };
	class H_Beret_grn								{ quality = 1; price = 500; };
	class H_Beret_grn_SF							{ quality = 1; price = 500; };
	class H_Beret_ocamo								{ quality = 1; price = 500; };
	class H_Beret_red								{ quality = 1; price = 500; };
	class H_Beret_gen_F              				{ quality = 1; price = 500; };
	...
	class H_HelmetB_light							{ quality = 2; price = 1000; };		// Armor: 4
	class H_HelmetB_light_black						{ quality = 2; price = 1000; };		// Armor: 4
	class H_HelmetB_light_desert					{ quality = 2; price = 1000; };		// Armor: 4
	class H_HelmetB_light_grass						{ quality = 2; price = 1000; };		// Armor: 4
	class H_HelmetB_light_sand						{ quality = 2; price = 1000; };		// Armor: 4
	class H_HelmetB_light_snakeskin					{ quality = 2; price = 1000; };		// Armor: 4
	class H_HelmetB_Light_tna_F       				{ quality = 2; price = 1000; };		// Armor: 4
	...
	class H_HelmetB									{ quality = 3; price = 1500; };		// Armor: 6
	class H_HelmetB_black							{ quality = 3; price = 1500; };		// Armor: 6
	class H_HelmetB_camo							{ quality = 3; price = 1500; };		// Armor: 6
	class H_HelmetB_desert							{ quality = 3; price = 1500; };		// Armor: 6
	class H_HelmetB_grass							{ quality = 3; price = 1500; };		// Armor: 6
	class H_HelmetB_paint							{ quality = 3; price = 1500; };		// Armor: 6
	class H_HelmetB_plain_blk						{ quality = 3; price = 1500; };		// Armor: 6
	class H_HelmetB_sand							{ quality = 3; price = 1500; };		// Armor: 6
	class H_HelmetB_snakeskin						{ quality = 3; price = 1500; };		// Armor: 6
	class H_HelmetB_tna_F             				{ quality = 3; price = 1500; };		// Armor: 6
	...
	class H_HelmetO_ocamo							{ quality = 4; price = 2000; };		// Armor: 8
	class H_HelmetO_oucamo							{ quality = 4; price = 2000; };		// Armor: 8
	class H_HelmetO_ghex_F            				{ quality = 4; price = 2000; };		// Armor: 8
	...
	class H_PilotHelmetHeli_B						{ quality = 3; price = 1500; };		// Armor: 6
	class H_PilotHelmetHeli_I						{ quality = 3; price = 1500; };		// Armor: 6
	class H_PilotHelmetHeli_O						{ quality = 3; price = 1500; };		// Armor: 6
	
	class H_HelmetCrew_I							{ quality = 4; price = 2000; };		// Armor: 8
	class H_HelmetCrew_B							{ quality = 4; price = 2000; };		// Armor: 8
	class H_HelmetCrew_O							{ quality = 4; price = 2000; };		// Armor: 8
	//	APEX DLC
	class H_HelmetCrew_O_ghex_F       				{ quality = 4; price = 2000; };		// Armor: 8
	
	class H_CrewHelmetHeli_B						{ quality = 5; price = 2500; };		// Armor: 10
	class H_CrewHelmetHeli_I						{ quality = 5; price = 2500; };		// Armor: 10
	class H_CrewHelmetHeli_O						{ quality = 5; price = 2500; };		// Armor: 10
	...
	class H_HelmetSpecB								{ quality = 5; price = 2500; };		// Armor: 10
	class H_HelmetSpecB_blk							{ quality = 5; price = 2500; };		// Armor: 10
	class H_HelmetSpecB_paint1						{ quality = 5; price = 2500; };		// Armor: 10
	class H_HelmetSpecB_paint2						{ quality = 5; price = 2500; };		// Armor: 10
	class H_HelmetB_Enh_tna_F         				{ quality = 5; price = 2500; };		// Armor: 10
	class H_HelmetB_TI_tna_F          				{ quality = 5; price = 2500; };		// Armor: 10
	...
	class H_HelmetSpecO_blk							{ quality = 5; price = 3000; };		// Armor: 10
	class H_HelmetSpecO_ocamo						{ quality = 5; price = 3000; };		// Armor: 10
	class H_HelmetSpecO_ghex_F        				{ quality = 5; price = 3000; };		// Armor: 10
	...
	class H_HelmetLeaderO_ocamo						{ quality = 6; price = 4000; };		// Armor: 12
	class H_HelmetLeaderO_oucamo					{ quality = 6; price = 4000; };		// Armor: 12
	class H_HelmetLeaderO_ghex_F      				{ quality = 6; price = 4000; };		// Armor: 12
	
	//	APEX DLC
	class H_HelmetO_ViperSP_hex_F     				{ quality = 6; price = 75000; };	// Armor: 20	Thermal Apex Helmet
	class H_HelmetO_ViperSP_ghex_F    				{ quality = 6; price = 75000; }; 	// Armor: 20	Thermal Apex Helmet
...
//	DIVING TRADER
	...
	class G_Diving			 						{ quality = 3; price = 500; };
	class G_B_Diving			 					{ quality = 3; price = 500; };
	class G_O_Diving			 					{ quality = 3; price = 500; };
	class G_I_Diving			 					{ quality = 3; price = 500; };
	...
	class U_I_Wetsuit								{ quality = 5; price = 5000; };
	class U_O_Wetsuit								{ quality = 5; price = 5000; };
	class U_B_Wetsuit								{ quality = 5; price = 5000; };
...
// SPEC OPS TRADER
	...
	class Binocular									{ quality = 2; price = 1000; };
	...
	class NVGoggles									{ quality = 5; price = 10000; };
	class NVGoggles_INDEP							{ quality = 5; price = 10000; };
	class NVGoggles_OPFOR							{ quality = 5; price = 10000; };
	class NVGoggles_tna_F             				{ quality = 5; price = 10000; };
	class O_NVGoggles_hex_F          				{ quality = 6; price = 15000; };
	class O_NVGoggles_urb_F           				{ quality = 6; price = 15000; };
	class O_NVGoggles_ghex_F          				{ quality = 6; price = 15000; };
	...
	class Exile_Headgear_GasMask					{ quality = 6; price = 15000; };
	...
	//	HE Grenade Rounds
	class 1Rnd_HE_Grenade_shell						{ quality = 2; price = 2000; };			// 40mm HE Grenade Round
	class 3Rnd_HE_Grenade_shell						{ quality = 3; price = 2000*3; };		// 40mm 3Rnd HE Grenade
	
	//	GRENADES
	class MiniGrenade								{ quality = 4; price = 1000; };			// RGN Grenade				Damage: 120HP
	class HandGrenade								{ quality = 4; price = 1500; };			// RGO Grenade				Damage: 160HP
	
	class APERSMine_Range_Mag						{ quality = 4; price = 2000; };			// APERS Mine				Damage: 200HP
	class APERSTripMine_Wire_Mag					{ quality = 4; price = 3000; };			// APERS Tripwire Mine		Damage: 300HP
	class APERSBoundingMine_Range_Mag				{ quality = 4; price = 4000; };			// APERS Bounding Mine		Damage: 400HP
	
	class ClaymoreDirectionalMine_Remote_Mag		{ quality = 4; price = 5000; };			// Claymore Charge			Damage: 800HP

	class SLAMDirectionalMine_Wire_Mag				{ quality = 5; price = 10000; };		// M6 SLAM Mine				Damage: 20.000HP

	class IEDLandSmall_Remote_Mag					{ quality = 5; price = 10000; };		// Small IED (Dug-in)		Damage: 20.000HP
	class IEDLandBig_Remote_Mag						{ quality = 6; price = 15000; };		// Large IED (Dug-in)		Damage: 40.000HP
	
	class IEDUrbanSmall_Remote_Mag					{ quality = 5; price = 10000; };		// Small IED (Urban)		Damage: 20.000HP
	class IEDUrbanBig_Remote_Mag					{ quality = 6; price = 15000; };		// Large IED (Urban)		Damage: 40.000HP
	
	class DemoCharge_Remote_Mag						{ quality = 5; price = 10000; };		// Explosive Charge			Damage: 20.000HP
	class SatchelCharge_Remote_Mag					{ quality = 6; price = 20000; };		// Explosive Satchel		Damage: 60.000HP
...
// HARDWARE TRADER
	...
	class Exile_Item_FuelCanisterEmpty				{ quality = 2; price = 100; };
	class Exile_Item_Rope							{ quality = 2; price = 200; };
	class Exile_Item_MetalScrews					{ quality = 2; price = 250; };
	class Exile_Item_DuctTape						{ quality = 2; price = 300; };
	class Exile_Item_LightBulb						{ quality = 2; price = 300; };
	class Exile_Item_ExtensionCord					{ quality = 2; price = 500; };
	class Exile_Item_MetalWire						{ quality = 2; price = 500; };
	class Exile_Item_Cement							{ quality = 2; price = 500; };
	...
	class Exile_Item_CarWheel						{ quality = 3; price = 1000; };
	class Exile_Item_JunkMetal						{ quality = 3; price = 1500; };
	class Exile_Item_MetalPole						{ quality = 3; price = 1500; };
	class Exile_Item_MetalBoard						{ quality = 3; price = 2000; };
	class Exile_Item_CamoTentKit					{ quality = 3; price = 2500; };
	class Exile_Item_MetalHedgehogKit				{ quality = 3; price = 2500; };
	class Exile_Item_BaseCameraKit					{ quality = 3; price = 2500; };
	class Exile_Item_CodeLock						{ quality = 4; price = 5000; };
	class Exile_Item_MobilePhone					{ quality = 4; price = 10000; };
	class Exile_Item_Laptop							{ quality = 4; price = 15000; };
	class Exile_Item_SafeKit						{ quality = 5; price = 20000; };
	...
	class Exile_Item_ZipTie							{ quality = 2; price = 500; };
	class Exile_Item_CookingPot						{ quality = 2; price = 500; };
	class Exile_Item_Handsaw						{ quality = 2; price = 1000; };
	class Exile_Item_Pliers							{ quality = 2; price = 1000; };
	class Exile_Item_Hammer							{ quality = 2; price = 1000; };
	class Exile_Item_OilCanister					{ quality = 2; price = 1000; };
	class Exile_Item_Screwdriver					{ quality = 2; price = 1000; };
	class Exile_Item_Wrench							{ quality = 2; price = 1000; };
	class Exile_Item_SleepingMat					{ quality = 2; price = 1500; };
	class Exile_Item_Grinder						{ quality = 2; price = 1500; };
	class Exile_Item_FireExtinguisher				{ quality = 2; price = 1500; };
	class Exile_Item_Foolbox						{ quality = 2; price = 5000; };
	class Exile_Item_CordlessScrewdriver			{ quality = 2; price = 5000; };
	class Exile_Item_Shovel							{ quality = 3; price = 2000; };
	class Exile_Melee_Axe							{ quality = 3; price = 2000; };
	...
	class Exile_Item_EMRE							{ quality = 5; price = 500; };	// 75, 60
	class Exile_Item_GloriousKnakworst				{ quality = 4; price = 475; };	// 60, 30
	class Exile_Item_Surstromming					{ quality = 4; price = 450; };	// 55, 25
	class Exile_Item_SausageGravy					{ quality = 4; price = 425; };	// 50, 25

	class Exile_Item_ChristmasTinner				{ quality = 3; price = 400; };	// 40, 60
	class Exile_Item_BBQSandwich					{ quality = 3; price = 400; };	// 40, 60
	class Exile_Item_MacasCheese					{ quality = 3; price = 400; };	// 40, 60
	class Exile_Item_Catfood						{ quality = 3; price = 350; };	// 40, 40
	
	class Exile_Item_Dogfood						{ quality = 2; price = 300; };	// 30, 30
	class Exile_Item_BeefParts						{ quality = 2; price = 300; };	// 30, 30
	class Exile_Item_Cheathas						{ quality = 2; price = 300; };	// 30, 30
	
	class Exile_Item_Noodles						{ quality = 1; price = 250; };	// 25, 50
	class Exile_Item_SeedAstics						{ quality = 1; price = 200; };	// 20, 40
	class Exile_Item_Raisins						{ quality = 1; price = 150; };	// 15, 30
	class Exile_Item_Moobar							{ quality = 1; price = 100; };	// 10, 30
	
	class Exile_Item_InstantCoffee					{ quality = 1; price = 250; };	// 5, 10
	...
	class Exile_Item_PlasticBottleCoffee	 		{ quality = 5; price = 400; sellPrice = 10; };//100, 60
	class Exile_Item_PowerDrink						{ quality = 4; price = 350; }; //95, 10
	class Exile_Item_PlasticBottleFreshWater 		{ quality = 4; price = 300; sellPrice = 4; }; //80, 15
	class Exile_Item_Beer 							{ quality = 3; price = 250; }; //75, 30
	class Exile_Item_EnergyDrink					{ quality = 3; price = 225; }; //75, 20
	class Exile_Item_MountainDupe					{ quality = 2; price = 200; }; //50, 20
	class Exile_Item_ChocolateMilk					{ quality = 1; price = 150; }; //35, 10
	...
	class Exile_Item_Defibrillator					{ quality = 5; price = 5000; };
	class Exile_Item_InstaDoc                       { quality = 4; price = 2500; };
	class Exile_Item_Vishpirin						{ quality = 3; price = 1000; };
	class Exile_Item_Heatpack	                    { quality = 2; price = 250; };
...
//	VEHICLE TRADER
	...
	class Exile_Car_Golf_Red						{ quality = 2; price = 10000; };	//	Golf (Red)					Speed: 216 /	Capacity: 1000	/	Armor: 22	/	Fuel Tank: 50l
	class Exile_Car_Golf_Black						{ quality = 2; price = 10000; }; 	//	Golf (Black)				Speed: 216 /	Capacity: 1000	/	Armor: 22	/	Fuel Tank: 50l
	
	class Exile_Car_Hatchback_Beige					{ quality = 2; price = 12500; }; 	//	Hatchback (Beige)			Speed: 150 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Hatchback_Green					{ quality = 2; price = 12500; };	//	Hatchback (Green)			Speed: 150 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Hatchback_Blue					{ quality = 2; price = 12500; };	//	Hatchback (Blue)			Speed: 150 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Hatchback_BlueCustom			{ quality = 2; price = 12500; };	//	Hatchback (Blue Custom)		Speed: 150 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Hatchback_BeigeCustom			{ quality = 2; price = 12500; };	//	Hatchback (Beige Custom)	Speed: 150 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Hatchback_Yellow				{ quality = 2; price = 12500; };	//	Hatchback (Yellow)			Speed: 150 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Hatchback_Grey					{ quality = 2; price = 12500; };	//	Hatchback (Grey)			Speed: 150 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Hatchback_Black					{ quality = 2; price = 12500; };	//	Hatchback (Black)			Speed: 150 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Hatchback_Dark					{ quality = 2; price = 12500; };	//	Hatchback (Dark)			Speed: 150 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Hatchback_Rusty1				{ quality = 2; price = 12500; };	//	Hatchback (Rusty1)			Speed: 150 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Hatchback_Rusty2				{ quality = 2; price = 12500; };	//	Hatchback (Rusty2)			Speed: 150 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	...
	class Exile_Car_Hatchback_Sport_Red				{ quality = 3; price = 22500; }; 	//	Hatchback SPORT (Red)		Speed: 325 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Hatchback_Sport_Blue			{ quality = 3; price = 22500; }; 	//	Hatchback SPORT (Blue)		Speed: 325 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Hatchback_Sport_Orange			{ quality = 3; price = 22500; }; 	//	Hatchback SPORT (Orange)	Speed: 325 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Hatchback_Sport_White			{ quality = 3; price = 22500; }; 	//	Hatchback SPORT (White)		Speed: 325 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Hatchback_Sport_Beige			{ quality = 3; price = 22500; }; 	//	Hatchback SPORT (Beige)		Speed: 325 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Hatchback_Sport_Green			{ quality = 3; price = 22500; }; 	//	Hatchback SPORT (Green)		Speed: 325 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	...
	class Exile_Car_SUVXL_Black 					{ quality = 3; price = 22500; }; 	//	SUV (Classic)				Speed: 220 /	Capacity: 1800	/	Armor: 40	/	Fuel Tank: 90l

	class Exile_Car_SUV_Armed_Black 				{ quality = 5; price = 100000; }; 	//	SUV (Classic Armed)			Speed: 230 /	Capacity: 1500	/	Armor: 80	/	Fuel Tank: 130l
	...
	class Exile_Car_Offroad_Repair_Civillian 		{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_Red 				{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_Beige 			{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_White 			{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_Blue 			{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_DarkRed 			{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_BlueCustom 		{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_Guerilla01 		{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_Guerilla02 		{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_Guerilla03 		{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_Guerilla04 		{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_Guerilla05 		{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_Guerilla06 		{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_Guerilla07 		{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_Guerilla08 		{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_Guerilla09 		{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_Guerilla10 		{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_Guerilla11 		{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_Offroad_Repair_Guerilla12 		{ quality = 4; price = 32500; }; 	//	Offroad (Repair)			Speed: 200 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 45l
	...
	class Exile_Car_UAZ_Green						{ quality = 3; price = 20000; }; 	//	UAZ (Green)					Speed: 168 /	Capacity: 1800	/	Armor: 32	/	Fuel Tank: 78l

	class Exile_Car_UAZ_Open_Green					{ quality = 3; price = 20000; }; 	//	UAZ Open (Green)			Speed: 168 /	Capacity: 1800	/	Armor: 32	/	Fuel Tank: 78l

	class Exile_Car_LandRover_Red 					{ quality = 3; price = 35000; }; 	//	Land Rover (Red)			Speed: 140 /	Capacity: 2200	/	Armor: 31	/	Fuel Tank: 70l
	class Exile_Car_LandRover_Urban 				{ quality = 3; price = 35000; }; 	//	Land Rover (Urban)			Speed: 140 /	Capacity: 2200	/	Armor: 31	/	Fuel Tank: 70l
	class Exile_Car_LandRover_Green 				{ quality = 3; price = 35000; }; 	//	Land Rover (Green)			Speed: 140 /	Capacity: 2200	/	Armor: 31	/	Fuel Tank: 70l
	class Exile_Car_LandRover_Sand 					{ quality = 3; price = 35000; }; 	//	Land Rover (Sand)			Speed: 140 /	Capacity: 2200	/	Armor: 31	/	Fuel Tank: 70l
	class Exile_Car_LandRover_Desert 				{ quality = 3; price = 35000; }; 	//	Land Rover (Desert)			Speed: 140 /	Capacity: 2200	/	Armor: 31	/	Fuel Tank: 70l

	class Exile_Car_LandRover_Ambulance_Green		{ quality = 4; price = 40000; }; 	//	Ambulance (Green)			Speed: 140 /	Capacity: 2500	/	Armor: 31	/	Fuel Tank: 70l
	class Exile_Car_LandRover_Ambulance_Desert		{ quality = 4; price = 40000; }; 	//	Ambulance (Desert)			Speed: 140 /	Capacity: 2500	/	Armor: 31	/	Fuel Tank: 70l
	class Exile_Car_LandRover_Ambulance_Sand		{ quality = 4; price = 40000; }; 	//	Ambulance (Sand)			Speed: 140 /	Capacity: 2500	/	Armor: 31	/	Fuel Tank: 70l

	//APEX
	class Exile_Car_MB4WD							{ quality = 3; price = 50000; };	//	MB4WD						Speed: 195 /	Capacity: 3000	/	Armor: 30	/	Fuel Tank: 45l
	class Exile_Car_MB4WDOpen						{ quality = 3; price = 50000; };	//	MB4WD Open					Speed: 195 /	Capacity: 3000	/	Armor: 30	/	Fuel Tank: 45l
	...
	class Exile_Car_Hunter 							{ quality = 6; price = 150000; };	//	Hunter						Speed: 115 /	Capacity: 2200	/	Armor: 200	/	Fuel Tank: 94l

	class Exile_Car_Ifrit 							{ quality = 6; price = 100000; };	//	Ifrit						Speed: 135 /	Capacity: 1800	/	Armor: 150	/	Fuel Tank: 94l

	class Exile_Car_Strider 						{ quality = 6; price = 175000; };	//	Strider						Speed: 125 /	Capacity: 1800	/	Armor: 250	/	Fuel Tank: 94l

	class Exile_Car_BRDM2_HQ 						{ quality = 6; price = 225000; };	//	BRDM2 HQ					Speed: 139 /	Capacity: 1500	/	Armor: 130	/	Fuel Tank: 280l

	class Exile_Car_BTR40_MG_Green 					{ quality = 6; price = 200000; };	//	BTR40 MG (Green)			Speed: 150 /	Capacity: 1500	/	Armor: 110	/	Fuel Tank: 140l
	class Exile_Car_BTR40_MG_Camo 					{ quality = 6; price = 200000; };	//	BTR40 MG (Camo)				Speed: 150 /	Capacity: 1500	/	Armor: 110	/	Fuel Tank: 140l
	class Exile_Car_BTR40_Green 					{ quality = 4; price = 50000; };	//	BTR40 (Green)				Speed: 150 /	Capacity: 1500	/	Armor: 110	/	Fuel Tank: 140l
	class Exile_Car_BTR40_Camo 						{ quality = 4; price = 50000; };	//	BTR40 (Camo)				Speed: 150 /	Capacity: 1500	/	Armor: 110	/	Fuel Tank: 140l

	class Exile_Car_HMMWV_M134_Green 				{ quality = 6; price = 90000; };	//	HMMWV M134 (Green)			Speed: 160 /	Capacity: 1500	/	Armor: 45	/	Fuel Tank: 250l
	class Exile_Car_HMMWV_M134_Desert 				{ quality = 6; price = 90000; };	//	HMMWV M134 (Desert)			Speed: 160 /	Capacity: 1500	/	Armor: 45	/	Fuel Tank: 250l
	...
	class Exile_Car_HMMWV_MEV_Green 				{ quality = 4; price = 70000; };	//	HMMWV Medical (Green)		Speed: 160 /	Capacity: 2000	/	Armor: 45	/	Fuel Tank: 250l
	class Exile_Car_HMMWV_MEV_Desert 				{ quality = 4; price = 70000; };	//	HMMWV Medical (Desert)		Speed: 160 /	Capacity: 2000	/	Armor: 45	/	Fuel Tank: 250l
	class Exile_Car_HMMWV_UNA_Green 				{ quality = 4; price = 70000; };	//	HMMWV Unarmed (Green)		Speed: 160 /	Capacity: 2000	/	Armor: 45	/	Fuel Tank: 250l
	class Exile_Car_HMMWV_UNA_Desert 				{ quality = 4; price = 70000; };	//	HMMWV Unarmed (Desert)		Speed: 160 /	Capacity: 2000	/	Armor: 45	/	Fuel Tank: 250l
	...
	class Exile_Car_Ikarus_Blue 					{ quality = 2; price = 50000; };	//	Ikarus (Blue)				Speed: 160	/	Capacity: 4000	/	Armor: 38	/	Fuel Tank: 200l
	class Exile_Car_Ikarus_Red 						{ quality = 2; price = 50000; };	//	Ikarus (Red)				Speed: 160	/	Capacity: 4000	/	Armor: 38	/	Fuel Tank: 200l
	class Exile_Car_Ikarus_Party 					{ quality = 2; price = 50000; };	//	Ikarus (Party)				Speed: 160	/	Capacity: 4000	/	Armor: 38	/	Fuel Tank: 200l

	class Exile_Car_Ural_Open_Blue					{ quality = 3; price = 60000; };	//	Ural Open (Blue)			Speed: 99	/	Capacity: 4500	/	Armor: 59	/	Fuel Tank: 300l
	class Exile_Car_Ural_Open_Yellow				{ quality = 3; price = 60000; };	//	Ural Open (Yellow)			Speed: 99	/	Capacity: 4500	/	Armor: 59	/	Fuel Tank: 300l
	class Exile_Car_Ural_Open_Worker				{ quality = 3; price = 60000; };	//	Ural Open (Worker)			Speed: 99	/	Capacity: 4500	/	Armor: 59	/	Fuel Tank: 300l
	class Exile_Car_Ural_Open_Military				{ quality = 3; price = 60000; };	//	Ural Open (Military)		Speed: 99	/	Capacity: 4500	/	Armor: 59	/	Fuel Tank: 300l

	class Exile_Car_Ural_Covered_Blue				{ quality = 3; price = 60000; };	//	Ural Covered (Blue)			Speed: 99	/	Capacity: 4500	/	Armor: 59	/	Fuel Tank: 300l
	class Exile_Car_Ural_Covered_Yellow				{ quality = 3; price = 60000; };	//	Ural Covered (Yellow)		Speed: 99	/	Capacity: 4500	/	Armor: 59	/	Fuel Tank: 300l
	class Exile_Car_Ural_Covered_Worker				{ quality = 3; price = 60000; };	//	Ural Covered (Worker)		Speed: 99	/	Capacity: 4500	/	Armor: 59	/	Fuel Tank: 300l
	class Exile_Car_Ural_Covered_Military			{ quality = 3; price = 60000; };	//	Ural Covered (Military)		Speed: 99	/	Capacity: 4500	/	Armor: 59	/	Fuel Tank: 300l

	class Exile_Car_V3S_Open						{ quality = 3; price = 55000; };	//	V3S Open					Speed: 75	/	Capacity: 4500	/	Armor: 50	/	Fuel Tank: 400l
	class Exile_Car_V3S_Covered						{ quality = 3; price = 55000; };	//	V3S Covered					Speed: 75	/	Capacity: 4500	/	Armor: 50	/	Fuel Tank: 400l

	class Exile_Car_Van_Black 						{ quality = 3; price = 40000; };	//	Van (Black)					Speed: 115 /	Capacity: 3600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_White 						{ quality = 3; price = 40000; };	//	Van (White)					Speed: 115 /	Capacity: 3600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Red 						{ quality = 3; price = 40000; };	//	Van (Red)					Speed: 115 /	Capacity: 3600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Guerilla01 					{ quality = 3; price = 40000; };	//	Van (Guerilla)				Speed: 115 /	Capacity: 3600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Guerilla02 					{ quality = 3; price = 40000; };	//	Van (Guerilla)				Speed: 115 /	Capacity: 3600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Guerilla03 					{ quality = 3; price = 40000; };	//	Van (Guerilla)				Speed: 115 /	Capacity: 3600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Guerilla04 					{ quality = 3; price = 40000; };	//	Van (Guerilla)				Speed: 115 /	Capacity: 3600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Guerilla05 					{ quality = 3; price = 40000; };	//	Van (Guerilla)				Speed: 115 /	Capacity: 3600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Guerilla06 					{ quality = 3; price = 40000; };	//	Van (Guerilla)				Speed: 115 /	Capacity: 3600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Guerilla07 					{ quality = 3; price = 40000; };	//	Van (Guerilla)				Speed: 115 /	Capacity: 3600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Guerilla08 					{ quality = 3; price = 40000; };	//	Van (Guerilla)				Speed: 115 /	Capacity: 3600	/	Armor: 80	/	Fuel Tank: 45l

	class Exile_Car_Van_Box_Black 					{ quality = 4; price = 65000; };	//	Van Box (Black)				Speed: 115 /	Capacity: 4600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Box_White 					{ quality = 4; price = 65000; };	//	Van Box (White)				Speed: 115 /	Capacity: 4600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Box_Red 					{ quality = 4; price = 65000; };	//	Van Box (Red)				Speed: 115 /	Capacity: 4600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Box_Guerilla01 				{ quality = 4; price = 65000; };	//	Van Box (Guerilla)			Speed: 115 /	Capacity: 4600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Box_Guerilla02 				{ quality = 4; price = 65000; };	//	Van Box (Guerilla)			Speed: 115 /	Capacity: 4600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Box_Guerilla03 				{ quality = 4; price = 65000; };	//	Van Box (Guerilla)			Speed: 115 /	Capacity: 4600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Box_Guerilla04 				{ quality = 4; price = 65000; };	//	Van Box (Guerilla)			Speed: 115 /	Capacity: 4600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Box_Guerilla05 				{ quality = 4; price = 65000; };	//	Van Box (Guerilla)			Speed: 115 /	Capacity: 4600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Box_Guerilla06 				{ quality = 4; price = 65000; };	//	Van Box (Guerilla)			Speed: 115 /	Capacity: 4600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Box_Guerilla07 				{ quality = 4; price = 65000; };	//	Van Box (Guerilla)			Speed: 115 /	Capacity: 4600	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Box_Guerilla08 				{ quality = 4; price = 65000; };	//	Van Box (Guerilla)			Speed: 115 /	Capacity: 4600	/	Armor: 80	/	Fuel Tank: 45l

	class Exile_Car_Van_Fuel_Black 					{ quality = 4; price = 45000; };	//	Van Fuel (Black)			Speed: 115 /	Capacity: 1100	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Fuel_White 					{ quality = 4; price = 45000; };	//	Van Fuel (White)			Speed: 115 /	Capacity: 1100	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Fuel_Red 					{ quality = 4; price = 45000; };	//	Van Fuel (Red)				Speed: 115 /	Capacity: 1100	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Fuel_Guerilla01 			{ quality = 4; price = 45000; };	//	Van Fuel (Guerilla)			Speed: 115 /	Capacity: 1100	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Fuel_Guerilla02 			{ quality = 4; price = 45000; };	//	Van Fuel (Guerilla)			Speed: 115 /	Capacity: 1100	/	Armor: 80	/	Fuel Tank: 45l
	class Exile_Car_Van_Fuel_Guerilla03 			{ quality = 4; price = 45000; };	//	Van Fuel (Guerilla)			Speed: 115 /	Capacity: 1100	/	Armor: 80	/	Fuel Tank: 45l

	class Exile_Car_Zamak 							{ quality = 5; price = 75000; };	//	Zamak						Speed: 80	/	Capacity: 4200	/	Armor: 100	/	Fuel Tank: 50l

	class Exile_Car_HEMMT 							{ quality = 5; price = 100000; };	//	HEMMT						Speed: 80	/	Capacity: 4600	/	Armor: 200	/	Fuel Tank: 245l
	
	class Exile_Car_Tempest 						{ quality = 5; price = 80000; };	//	Tempest						Speed: 90	/	Capacity: 3800	/	Armor: 200	/	Fuel Tank: 250l
...
//	BOAT TRADER
	...
	class Exile_Boat_MotorBoat_Police				{ quality = 2; price = 30000; };	//	Motor Boat (Police)
	class Exile_Boat_MotorBoat_Orange				{ quality = 2; price = 30000; };	//	Motor Boat (Orange)
	class Exile_Boat_MotorBoat_White				{ quality = 2; price = 30000; };	//	Motor Boat (White)

	class Exile_Boat_RubberDuck_CSAT				{ quality = 3; price = 15000; };	//	Rubber Duck (CSAT)
	class Exile_Boat_RubberDuck_Digital				{ quality = 3; price = 15000; };	//	Rubber Duck (Digital)
	class Exile_Boat_RubberDuck_Orange				{ quality = 3; price = 15000; };	//	Rubber Duck (Orange)
	class Exile_Boat_RubberDuck_Blue				{ quality = 3; price = 15000; };	//	Rubber Duck (Blue)
	class Exile_Boat_RubberDuck_Black				{ quality = 3; price = 15000; };	//	Rubber Duck (Black)

	class Exile_Boat_SDV_CSAT						{ quality = 4; price = 50000; };	//	SDV (CSAT)
	class Exile_Boat_SDV_Digital					{ quality = 4; price = 50000; };	//	SDV (Digital)
	class Exile_Boat_SDV_Grey						{ quality = 4; price = 50000; };	//	SDV (Grey)
	
	class Exile_Boat_WaterScooter					{ quality = 1; price = 2000; };		//	Water Scooter

	//	Apex DLC
	class Exile_Boat_RHIB							{ quality = 4; price = 45000; };	//	RHIB						Speed: 95 /	Capacity: 500	/	Armor: 0	/	Fuel Tank: 100l
...
//	AIRCRAFT TRADER
	...
	class Exile_Chopper_Hummingbird_Green						{ quality = 2; price = 250000; };	//	Hummingbird		Speed: 245 /	Capacity: 1300	/	Armor: 30	/	Fuel Tank: 242l
	
	class Exile_Chopper_Huey_Green 								{ quality = 3; price = 300000; };	//	UH-1H Huey		Speed: 217 /	Capacity: 2500	/	Armor: 40	/	Fuel Tank: 250l
	class Exile_Chopper_Huey_Desert								{ quality = 3; price = 300000; };	//	UH-1H Huey		Speed: 217 /	Capacity: 2500	/	Armor: 40	/	Fuel Tank: 250l
	class Exile_Chopper_Huey_Armed_Green						{ quality = 3; price = 400000; };	//	UH-1H Huey		Speed: 217 /	Capacity: 2500	/	Armor: 40	/	Fuel Tank: 300l
	class Exile_Chopper_Huey_Armed_Desert						{ quality = 3; price = 400000; };	//	UH-1H Huey		Speed: 217 /	Capacity: 2500	/	Armor: 40	/	Fuel Tank: 300l
	...
	class Exile_Chopper_Mohawk_FIA								{ quality = 5; price = 700000; };	//	Mohawk			Speed: 300 /	Capacity: 4800	/	Armor: 40	/	Fuel Tank: 2500l
	
	class Exile_Chopper_Orca_CSAT								{ quality = 4; price = 650000; };	//	Orca			Speed: 290 /	Capacity: 4600	/	Armor: 40	/	Fuel Tank: 800l
	class Exile_Chopper_Orca_Black								{ quality = 4; price = 650000; };	//	Orca			Speed: 290 /	Capacity: 4600	/	Armor: 40	/	Fuel Tank: 800l
	class Exile_Chopper_Orca_BlackCustom						{ quality = 4; price = 650000; };	//	Orca			Speed: 290 /	Capacity: 4600	/	Armor: 40	/	Fuel Tank: 800l
	...
	class Exile_Chopper_Huron_Black								{ quality = 6; price = 900000; };	//	Huron			Speed: 300 /	Capacity: 6000	/	Armor: 40	/	Fuel Tank: 1360l
	class Exile_Chopper_Huron_Green								{ quality = 6; price = 900000; };	//	Huron			Speed: 300 /	Capacity: 6000	/	Armor: 40	/	Fuel Tank: 1360l
	...
	class Exile_Plane_Cessna									{ quality = 1; price = 200000; };	//	Cessna			Speed: 290 /	Capacity: 1300	/	Armor: 20	/	Fuel Tank: 1000l

	class Exile_Plane_AN2_Green									{ quality = 3; price = 400000; };	//	AN-2			Speed: 262 /	Capacity: 2500	/	Armor: 35	/	Fuel Tank: 800l
	class Exile_Plane_AN2_White									{ quality = 3; price = 400000; };	//	AN-2			Speed: 262 /	Capacity: 2500	/	Armor: 35	/	Fuel Tank: 800l
	class Exile_Plane_AN2_Stripe								{ quality = 3; price = 400000; };	//	AN-2			Speed: 262 /	Capacity: 2500	/	Armor: 35	/	Fuel Tank: 800l
...
#include "EBM\traders.hpp"
	...
	class Ammunition
	{
		...
		items[] =
		{
			...
			"Exile_Magazine_20Rnd_762x51_DMR",						//	DMR
			"Exile_Magazine_20Rnd_762x51_DMR_Yellow",				//	DMR
			"Exile_Magazine_20Rnd_762x51_DMR_Red",					//	DMR
			"Exile_Magazine_20Rnd_762x51_DMR_Green",				//	DMR
			"Exile_Magazine_10Rnd_93x64_DMR_05_Bullet_Cam_Mag",		//	DMR
			//"Exile_Magazine_8Rnd_9x18",							//	Makarov
			"Exile_Magazine_7Rnd_45ACP",							//	Colt 1911
			"Exile_Magazine_6Rnd_45ACP",							//	Revolver
			"Exile_Magazine_5Rnd_22LR",							//	CZ550
			"Exile_Magazine_10Rnd_762x54",							//	SVD
			//"Exile_Magazine_10Rnd_303",							//	Lee-Enfield
			"Exile_Magazine_10Rnd_9x39",							//	VSS Vintorez
			//"Exile_Magazine_20Rnd_9x39",							//	VSS Vintorez ??
			//	XM1014
	...
	class NIAAR15
	{
		...
		items[] =
		{
			...
			"hlc_30rnd_556x45_SPR"							// 30 Round magazine of 5.56x45mm NATO Mk262 Rounds (designed for long range ballistic consistency).
		};
	};
	...
	class NIAACR
	{
		...
		items[] =
		{
			...
			"hlc_rifle_ACR68_Carb_black",					//	Remington ACR-E in 6.8mm SPCII with 14.5" Barrel (Black)
			"hlc_rifle_ACR68_Carb_tan",						//	Remington ACR-E in 6.8mm SPCII with 14.5" Barrel (Tan)
			"hlc_rifle_ACR68_Carb_green",					//	Remington ACR-E in 6.8mm SPCII with 14.5" Barrel (Green)
		
			"hlc_rifle_ACR68_MID_black",					//	Remington ACR-E in 6.8mm SPCII with 16.5" Barrel (Black)
			"hlc_rifle_ACR68_MID_tan",						//	Remington ACR-E in 6.8mm SPCII with 16.5" Barrel (Tan)
			"hlc_rifle_ACR68_MID_green",					//	Remington ACR-E in 6.8mm SPCII with 16.5" Barrel (Green)
		
			"hlc_rifle_ACR68_full_black",					//	Remington ACR-E in 6.8mm SPCII with 20" Barrel (Black)
			"hlc_rifle_ACR68_full_tan",						//	Remington ACR-E in 6.8mm SPCII with 20" Barrel (Tan)
			"hlc_rifle_ACR68_full_green",					//	Remington ACR-E in 6.8mm SPCII with 20" Barrel (Green)

			"hlc_rifle_ACR_SBR_tan",						//	Remington ACR-E in 5.56mm NATO with 10.5" Barrel (Tan)
			"hlc_rifle_ACR_SBR_black",						//	Remington ACR-E in 5.56mm NATO with 10.5" Barrel (Black)
			"hlc_rifle_ACR_SBR_green",						//	Remington ACR-E in 5.56mm NATO with 10.5" Barrel (Green)
		
			"hlc_rifle_ACR_Carb_black",						//	Remington ACR-E in 5.56mm NATO with 14.5" Barrel (Black)
			"hlc_rifle_ACR_Carb_tan",						//	Remington ACR-E in 5.56mm NATO with 14.5" Barrel (Tan)
			"hlc_rifle_ACR_Carb_green",						//	Remington ACR-E in 5.56mm NATO with 14.5" Barrel (Green)
		
			"hlc_rifle_ACR_MID_black",						//	Remington ACR-E in 5.56mm NATO with 16.5" Barrel (Black)
			"hlc_rifle_ACR_MID_tan",						//	Remington ACR-E in 5.56mm NATO with 16.5" Barrel (Tan)
			"hlc_rifle_ACR_MID_green",						//	Remington ACR-E in 5.56mm NATO with 16.5" Barrel (Green)
		
			"hlc_rifle_ACR_full_black",						//	Remington ACR-E in 5.56mm NATO with 20" Barrel (Black)
			...
			"hlc_rifleACR_SBR_cliffhanger",					//	Remington ACR-E in 5.56mm NATO with 10.5" Barrel - Cliffhanger special edition
			...
			"hlc_30rnd_68x43_MIRDIM"						//	26-round magazine of 1-to-4 NATO-spec IR-DIM/FMJ 6.8x43mm SPC
		};
	};
	...
	class NIAAUG
	{
		...
		items[] =
		{
			...
			"hlc_rifle_auga1_t",							//	Steyr AUGA1 - Rifle-barrel (Tan)
			"hlc_rifle_auga1_B",							//	Steyr AUGA1 - Rifle-barrel (Black)

			"hlc_rifle_auga1carb",							//	Steyr AUGA1 - Carbine-barrel
			"hlc_rifle_auga1carb_t",						//	Steyr AUGA1 - Carbine-barrel (Tan)
			"hlc_rifle_auga1carb_b",						//	Steyr AUGA1 - Carbine-barrel (Black)

			"hlc_rifle_aughbar",							//	Steyr AUGA1 - Heavy Barrel
			"hlc_rifle_aughbar_t",							//	Steyr AUGA1 - Heavy Barrel (Tan)
			"hlc_rifle_aughbar_b",							//	Steyr AUGA1 - Heavy Barrel (Black)

			"hlc_rifle_augpara",							//	Steyr AUGA1 - 9mm Para
			"hlc_rifle_augpara_t",							//	Steyr AUGA1 - 9mm Para (Tan)
			"hlc_rifle_augpara_b",							//	Steyr AUGA1 - 9mm Para (Black)

			"hlc_rifle_auga2",								//	Steyr AUGA2 - Rifle-barrel (Default OD)
			"hlc_rifle_auga2_t",							//	Steyr AUGA2 - Rifle-barrel (Tan)
			"hlc_rifle_auga2_b",							//	Steyr AUGA2 - Rifle-barrel (Black)

			"hlc_rifle_auga2carb",							//	Steyr AUGA2 - Carbine-barrel
			"hlc_rifle_auga2carb_t",						//	Steyr AUGA2 - Carbine-barrel (Tan)
			"hlc_rifle_auga2carb_b",						//	Steyr AUGA2 - Carbine-barrel (Black)

			"hlc_rifle_auga2lsw",							//	Steyr AUGA2 - Heavy Barrel
			"hlc_rifle_auga2lsw_t",							//	Steyr AUGA2 - Heavy Barrel (Tan)
			"hlc_rifle_auga2lsw_b",							//	Steyr AUGA2 - Heavy Barrel (Black)

			"hlc_rifle_auga2para",							//	Steyr AUGA2 - 9mm Para
			"hlc_rifle_auga2para_t",						//	Steyr AUGA2 - 9mm Para (Tan)
			"hlc_rifle_auga2para_b",						//	Steyr AUGA2 - 9mm Para (Black)

			"hlc_rifle_augsr",								//	Steyr AUGSR (Special Receiver) - Rifle-barrel (Default OD)
			"hlc_rifle_augsr_t",							//	Steyr AUGSR (Special Receiver) - Rifle-barrel (Tan)
			"hlc_rifle_augsr_b",							//	Steyr AUGSR (Special Receiver) - Rifle-barrel (Black)

			"hlc_rifle_augsrcarb",							//	Steyr AUGSR (Special Receiver) - Carbine-barrel
			"hlc_rifle_augsrcarb_t",						//	Steyr AUGSR (Special Receiver) - Carbine-barrel (Tan)
			"hlc_rifle_augsrcarb_b",						//	Steyr AUGSR (Special Receiver) - Carbine-barrel (Black)

			"hlc_rifle_augsrhbar",							//	Steyr AUGSR (Special Receiver) - Heavy Barrel
			"hlc_rifle_augsrhbar_t",						//	Steyr AUGSR (Special Receiver) - Heavy Barrel (Tan)
			"hlc_rifle_augsrhbar_b",						//	Steyr AUGSR (Special Receiver) - Heavy Barrel (Black)

			"hlc_rifle_auga3",								//	Steyr AUGA3- Rifle-barrel (Default Green)
			"hlc_rifle_auga3_bl",							//	Steyr AUGA3- Rifle-barrel (Blue)
			"hlc_rifle_auga3_b",							//	Steyr AUGA3- Rifle-barrel (Black)

			"hlc_rifle_auga3_GL",							//	Steyr AUGA3 with M203A1
			"hlc_rifle_auga3_GL_BL",						//	Steyr AUGA3 with M203A1 (Blue)
			"hlc_rifle_auga3_GL_B",							//	Steyr AUGA3 with M203A1 (Black)
			...
			"hlc_30Rnd_556x45_SPR_AUG",						//	30 Round magazine of 5.56x45mm NATO Mk262 Rounds (Designed for long range ballistic consistency for the Steyr AUG).
			...
			"hlc_40Rnd_556x45_SPR_AUG",						//	42 Round magazine of 5.56x45mm NATO Mk262 Rounds (Designed for long range ballistic consistency for the Steyr AUG).
	...
	class NIAFAL
	{
		...
		items[] =
		{
			...
			"hlc_rifle_FAL5061",							//	FN FAL 50.61 'Para' 
			"hlc_rifle_FAL5061Rail",						//	FN FAL 50.61 'Para' with Picatinny Rail Interface
			"hlc_rifle_FAL5000",							//	FN FAL 50.00 
			"hlc_rifle_FAL5000Rail",						//	FN FAL 50.00 with Picatinny Rail Interface
			"hlc_rifle_c1A1",								//	Canadian Arms Limited C1A1 (Canadian SLR variant, First Formally adopted FAL Rifle)
			...
			"hlc_rifle_SLRchopmod",							//	Lithgow SLR Chopmod ( Litghow SLR with the selector group from an L2A1 , Barrel sawn down and flash suppressor omitted, additional pistol grip drilled to foregrip. SASR armorer improvised solution to recon egnagements in Vietnam.)
			...
			"hlc_50rnd_762x51_M_FAL"						//	50 Round magazine of 7.62x51mm Mixed at a ratio of 1 Tracer for every 5 Standard Ball rounds (X-systems drum mag, so you can have the SAW be interoperable with the rest of the squad.)
		};
	};
	
	class NIAFN3011
	{
		name = "NIA FN3011 Rifles";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] =
		{
			"hlc_rifle_FN3011",		 	 						// FN 3011 Factory Issue - 7.62mmx51 NATO
			"hlc_rifle_FN3011_WDL",		 						// FN 3011 (Light Woodland Camo) - 7.62mmx51 NATO
			"hlc_rifle_FN3011Modern",		 					// FN 3011 (Modernised- M1913 Scout Rail, M1913 Bipod Adapter, Threaded Muzzle) - 7.62mmx51 NATO
			"hlc_rifle_FN3011Modern_camo",						// FN 3011 (Modernised-Camo) - 7.62mmx51 NATO
			"hlc_rifle_FN3011Lynx",								// FN 3011 (Modernised-Special Commissionfor Lynx) - 7.62mmx51 NATO
			"hlc_rifle_FN3011Tactical",							// FN 3011 (Tactical, Brown Laminate) - 7.62mmx51 NATO
			"hlc_rifle_FN3011Tactical_grey",					// FN 3011 (Tactical, Grey Laminate) - 7.62mmx51 NATO
			"hlc_rifle_FN3011Tactical_green",					// FN 3011 (Tactical, Green Laminate) - 7.62mmx51 NATO

			//	FN 30-11 Ammo //
			"hlc_10Rnd_762x51_B_fal",		     				// 10-round FN FAL/FN3011 Magazine loaded with EPR rounds.
			"hlc_10Rnd_762x51_mk316_fal",		 				// 10-round FN FAL/FN3011 Magazine loaded with SBLR rounds.
			"hlc_10Rnd_762x51_barrier_fal",	 					// 10-round FN FAL/FN3011 Magazine loaded with SOST rounds.
			"hlc_10Rnd_762x51_T_fal",	        				// 10-round FN FAL/FN3011 Magazine loaded with Tracer rounds.
			"hlc_10Rnd_762x51_TDim_fal",						// 10-round FN FAL/FN3011 Magazine loaded with IR-Dim Tracer rounds.
			"hlc_10Rnd_762x51_S_fal"          					// 10-round FN FAL/FN3011 Magazine loaded with cold-load subsonic EPR rounds.
		};
	};
	...
	class NIAM1903
	{
		...
		items[] =
		{
			"hlc_rifle_M1903A1_unertl"					//	M1903A1 Rifle permanently fitted with 8x Unertl Scope
			"hlc_rifle_M1903A1"							//	M1903A1 Service Rifle

			// M1903 Springfield Ammo
			"hlc_5rnd_3006_1903"						//	5-round clip of .30-06 M1 Military Ball.
		};
	};
	...
	class NIAMG42
	{
		...
		items[] =
		{
			...
			"hlc_lmg_MG3KWS_g",			 				//	Rheinmetall MG3-KWS : Kampfwertsteigerung (Combat Improvements Model)(Black)
			"hlc_lmg_MG42KWS_t",			 			//	Rheinmetall MG42-KWS : MG3KWS fitted with MG42 components (Tan/RAL)
			"hlc_lmg_MG42KWS_g",		 				//	Rheinmetall MG42-KWS : MG3KWS fitted with MG42 components (Green/RAL)
			"hlc_lmg_MG42KWS_B",			 			//	Rheinmetall MG42-KWS : MG3KWS fitted with MG42 components (Black)

			// MG42s/MG42 Ammo
			"hlc_50Rnd_792x57_B_MG42",					//	Gurtrommel with 50 Rounds of 7.92x57mm sS Patrone (FMJ)				 - MG42
			"hlc_50Rnd_792x57_M_MG42",					//	Gurtrommel with 50 Rounds of 7.92x57mm S.m.K -v and S.m.K Leuchtspur (EPR/Tracer 4:1)	 - MG42
			"hlc_50Rnd_792x57_T_MG42",					//	Gurtrommel with 50 Rounds of 7.92x57mm S.m.K Leuchtspur (Tracer)				 - MG42
			"hlc_100Rnd_792x57_B_MG42",					//	100 Rounds of 7.92x57mm sS Patrone (FMJ)						 - MG42
			"hlc_100Rnd_792x57_M_MG42",					//	100 Rounds of  7.92x57mm S.m.K -v and S.m.K Leuchtspur (EPR/Tracer 4:1)	 	 	 - MG42	
			"hlc_100Rnd_792x57_T_MG42",					//	100 Rounds of  7.92x57mm S.m.K Leuchtspur (Tracer)					 - MG42
			"hlc_200Rnd_792x57_B_MG42",					//	200 Rounds of 7.92x57mm sS Patrone (FMJ)						 - MG42
			"hlc_200Rnd_792x57_M_MG42",					//	200 Rounds of  7.92x57mm S.m.K -v and S.m.K Leuchtspur (EPR/Tracer 4:1)			 - MG42
			"hlc_200Rnd_792x57_T_MG42",					//	200 Rounds of  7.92x57mm S.m.K Leuchtspur (Tracer)					 - MG42
			"hlc_50Rnd_792x57_AP_MG42",					//	Gurtrommel with 50 Rounds of 7.92x57mm S.m.K.H (AP)					 - MG42
			"hlc_100Rnd_792x57_AP_MG42",				//	100 Rounds of 7.92x57mm S.m.K.H (AP)						 - MG42
			"hlc_200Rnd_792x57_AP_MG42",				//	200 Rounds of 7.92x57mm S.m.K.H (AP)	 					 - MG42
			"hlc_50Rnd_762x51_B_MG3",					//	Gurtrommel with 50 Rounds of 7.62x51mm M855A1 in DM1 Links (FMJ)
			"hlc_50Rnd_762x51_M_MG3",					//	Gurtrommel with 50 Rounds of 7.62x51mm M855A1 in DM1 Links (FMJ/Tracer 4:1)
			"hlc_50Rnd_762x51_Barrier_MG3",				//	Gurtrommel with 50 Rounds of 7.62x51mm Mk.319 EPBR in DM1 Links (Mk319/Tracer 4:1)
			"hlc_50Rnd_762x51_T_MG3",					//	Gurtrommel with 50 Rounds of 7.62x51mm M64 in DM1 Links (Tracer)
			"hlc_100Rnd_762x51_B_MG3",					//	100 Rounds of 7.62x51mm M855A1 in DM1 Links (FMJ)
			"hlc_100Rnd_762x51_M_MG3",					//	100 Rounds of 7.62x51mm M855A1 in DM1 Links (FMJ/Tracer 4:1)
			"hlc_100Rnd_762x51_Barrier_MG3",			//	100 Rounds of 7.62x51mm Mk.319 EPBR in DM1 Links (Mk319/Tracer 4:1)
			"hlc_100Rnd_762x51_T_MG3",					//	100 Rounds of 7.62x51mm M64 in DM1 Links (Tracer)
			"hlc_250Rnd_762x51_B_MG3",					//	200 Rounds of 7.62x51mm M855A1 in DM1 Links (FMJ)
			"hlc_250Rnd_762x51_M_MG3",					//	200 Rounds of 7.62x51mm M855A1 in DM1 Links (FMJ/Tracer 4:1)
			"hlc_250Rnd_762x51_Barrier_MG3",			//	200 Rounds of 7.62x51mm Mk.319 EPBR in DM1 Links (Mk319/Tracer 4:1)
			"hlc_1250Rnd_762x51_T_MG3"					//	200 Rounds of 7.62x51mm M64 in DM1 Links (Tracer)
		};
	};		
	...
	class NIASG510
	{
		name = "NIA SG510 Rifles";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] =
		{
			"hlc_rifle_STGW57",							//	SIG Sturmgewehr 57/Fass 57.Can mount Kern AARAU 4x24 Scope. 7.5x55mm
			"hlc_rifle_stgw57_RIS",						//	SIG Sturmgewehr 57/Fass 57 with Richner-Waffen Picatinny Rail Mount.
			"hlc_rifle_stgw57_commando",				//	Customized STGW 57, with Cut-down barrel. Inspired by Swiss gunsmith Rudolf Aebi.
			"hlc_rifle_sig5104", 						//	SIG 510/4. 7.62x51mm NATO
			"hlc_rifle_amt",							//	Sig AMT (American Match Target) in 7.62 NATO. No Bipod.

			// SG510 Ammo //
			"hlc_24Rnd_75x55_B_stgw",	 				//	24 Round Stgw57 magazine of GP11 175gr Military FMJ 
			"hlc_24Rnd_75x55_ap_stgw",	 				//	24 Round Stgw57 magazine of GP11 180gr Armour-piercing Boat-Tail
			"hlc_20Rnd_762x51_b_amt",					//	20 Round SG510-4 magazine of 7.62x51mm Enhanced FMJ
			"hlc_20Rnd_762x51_mk316_amt",				//	20 Round SG510-4 magazine of 7.62x51mm mk.316 Match
			"hlc_20Rnd_762x51_bball_amt",				//	20 Round SG510-4 magazine of 7.62x51mm mk.319 SOST Barrier Ball
			"hlc_20Rnd_762x51_T_amt",					//	20 Round SG510-4 magazine of 7.62x51mm Tracer rounds
			"hlc_24Rnd_75x55_T_stgw"					//	24 Round  Stgw57 magazine of GP11 Tracer rounds
		};
	};
